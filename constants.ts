...
export const ADMIN_EMAIL = "nadim841442@gmail.com";
export const SUPPORT_EMAIL = "nadim841442@gmail.com";
...
export const DEFAULT_APP_FEATURES = [
    ...
    { id: 'f4', title: 'Weekly Live Tests', enabled: true, order: 4 },
    { id: 'f5', title: 'Live Leaderboard', enabled: true, order: 5 },
    { id: 'f6', title: 'Engagement Rewards', enabled: true, order: 6 },
    { id: 'f7', title: 'Private Admin Support', enabled: true, order: 7 },
    { id: 'f8', title: 'Spin Wheel Game', enabled: true, order: 8 },
    { id: 'f9', title: 'Credit System', enabled: true, order: 9 },
    { id: 'f10', title: 'Subscription Plans', enabled: true, order: 10 },
    { id: 'f11', title: 'Store & Payments', enabled: true, order: 11 },
    { id: 'f12', title: 'Profile Customization', enabled: true, order: 12 },
    { id: 'f13', title: 'Study Timer', enabled: true, order: 13 },
    { id: 'f14', title: 'Streak System', enabled: true, order: 14 },
    { id: 'f15', title: 'User Inbox', enabled: true, order: 15 },
    { id: 'f16', title: 'Performance History', enabled: true, order: 16 },
    { id: 'f17', title: 'Responsive Design', enabled: true, order: 17 },
    { id: 'f18', title: 'PDF Watermarking', enabled: true, order: 18 },
    { id: 'f19', title: 'Auto-Sync Content', enabled: true, order: 19 },
    { id: 'f20', title: 'Passwordless Login', enabled: true, order: 20 },
    { id: 'f21', title: 'Gift Codes', enabled: true, order: 21 },
    { id: 'f22', title: 'Featured Shortcuts', enabled: true, order: 22 },
    { id: 'f23', title: 'Notice Board', enabled: true, order: 23 },
    { id: 'f24', title: 'External Apps Integration', enabled: true, order: 24 },
    { id: 'f25', title: 'AI Question Generator', enabled: true, order: 25 },
    { id: 'f26', title: 'Class Management (6-12)', enabled: true, order: 26 },
    { id: 'f27', title: 'Daily Goals', enabled: true, order: 27 },
    { id: 'f28', title: 'Referral System', enabled: true, order: 28 },
    { id: 'f29', title: 'Offline Mode Support', enabled: true, order: 29 },
    { id: 'f30', title: 'Multi-Board Support', enabled: true, order: 30 }
];
